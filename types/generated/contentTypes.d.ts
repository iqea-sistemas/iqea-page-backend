...
export interface ApiFormAnaerobicSystemRequestFormAnaerobicSystemRequest
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::form-anaerobic-system-request.form-anaerobic-system-request'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFormBiologicalTreatmentRequestFormBiologicalTreatmentRequest
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    EffluentRequirements: Schema.Attribute.Component<
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::form-biological-treatment-request.form-biological-treatment-request'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFormMovingBedBiofilmReactorFormMovingBedBiofilmReactor
  extends Struct.CollectionTypeSchema {
  collectionName: 'form_moving_bed_biofilm_reactors';
  info: {
    displayName: 'FormMovingBedBiofilmReactor';
    pluralName: 'form-moving-bed-biofilm-reactors';
    singularName: 'form-moving-bed-biofilm-reactor';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::form-moving-bed-biofilm-reactor.form-moving-bed-biofilm-reactor'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFormOsmosisDesignRequestFormOsmosisDesignRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'form_osmosis_design_requests';
  info: {
    description: '';
    displayName: 'FormOsmosisDesignRequest';
    pluralName: 'form-osmosis-design-requests';
    singularName: 'form-osmosis-design-request';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    AlimentacionSistema: Schema.Attribute.Component<
      'forms.form-alimentacion-al-sistema',
      false
    >;
    AnalisisQuimico: Schema.Attribute.Component<
      'forms.form-analisis-quimico',
      false
    >;
    ContanctInfo: Schema.Attribute.Component<'forms.form-customer-info', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    EspacioDisponible: Schema.Attribute.Component<
      'forms.form-espacio-maximo-disponible',
      false
    >;
    FuenteAguaAlimentacion: Schema.Attribute.Component<
      'forms.fuente-agua-alimentacion',
      false
    >;
    FuenteEnergia: Schema.Attribute.Component<'forms.fuente-energia', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::form-osmosis-design-request.form-osmosis-design-request'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    RequisitosAguaTratada: Schema.Attribute.Component<
      'forms.form-requisito-agua-tratada',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiFormPhysicochemicalDesignRequestFormPhysicochemicalDesignRequest
  extends Struct.CollectionTypeSchema {
  collectionName: 'form_physicochemical_design_requests';
  info: {
    description: '';
    displayName: 'FormPhysicochemicalDesignRequest';
    pluralName: 'form-physicochemical-design-requests';
    singularName: 'form-physicochemical-design-request';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::form-physicochemical-design-request.form-physicochemical-design-request'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiFormSedimentationClarifierDesignRequestFormSedimentationClarifierDesignRequest
  extends Struct.CollectionTypeSchema {
...
export interface ApiFormForm extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Links: Schema.Attribute.Component<'general.link-slug-name', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::form-anaerobic-system-request.form-anaerobic-system-request': ApiFormAnaerobicSystemRequestFormAnaerobicSystemRequest;
      'api::form-biological-treatment-request.form-biological-treatment-request': ApiFormBiologicalTreatmentRequestFormBiologicalTreatmentRequest;
      'api::form-contact.form-contact': ApiFormContactFormContact;
      'api::form-moving-bed-biofilm-reactor.form-moving-bed-biofilm-reactor': ApiFormMovingBedBiofilmReactorFormMovingBedBiofilmReactor;
      'api::form-osmosis-design-request.form-osmosis-design-request': ApiFormOsmosisDesignRequestFormOsmosisDesignRequest;
      'api::form-physicochemical-design-request.form-physicochemical-design-request': ApiFormPhysicochemicalDesignRequestFormPhysicochemicalDesignRequest;
      'api::form-sedimentation-clarifier-design-request.form-sedimentation-clarifier-design-request': ApiFormSedimentationClarifierDesignRequestFormSedimentationClarifierDesignRequest;
